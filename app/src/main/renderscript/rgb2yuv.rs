...
void RS_KERNEL convert(uchar4 in, uint32_t x, uint32_t y) {
    ...
    int uInt = (int) (  0.439f * r - 0.368f * g - 0.071f * b) + 128;
    int vInt = (int) (- 0.148f * r - 0.291f * g + 0.439f * b) + 128;
    ...
    if ((x & 0x01) == 0 && (y & 0x01) == 0) {
        ...
        rsSetElementAt_uchar(gOut, uChar, offset);
        rsSetElementAt_uchar(gOut, vChar, offset + 1);
    }
}
