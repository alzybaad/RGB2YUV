...
Java_team_birdhead_rgb2yuv_converter_LibYuvConverter_rgbToBgrInternal(JNIEnv *env, jobject,
...
JNIEXPORT void JNICALL
Java_team_birdhead_rgb2yuv_converter_LibYuvConverter_bgrToYuvInternal(JNIEnv *env, jobject,
